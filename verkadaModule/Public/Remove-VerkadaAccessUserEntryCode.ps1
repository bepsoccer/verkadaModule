function Remove-VerkadaAccessUserEntryCode{
	<#
		...
		This will dremove the Access user's entry code with userId 801c9551-b04c-4293-84ad-b0a6aa0588b3 and send an email invite for the Pass app.  The org_id and tokens will be populated from the cached created by Connect-Verkada.
		
		.EXAMPLE
		Remove-VerkadaAccessUserEntryCode -externalId 'newUserUPN@contoso.com' -org_id '7cd47706-f51b-4419-8675-3b9f0ce7c12d' -x_verkada_token 'a366ef47-2c20-4d35-a90a-10fd2aee113a'
		This will dremove the Access user's entry code with -externalId 'newUserUPN@contoso.com'.  The org_id and tokens are submitted as parameters in the call.
	#>
