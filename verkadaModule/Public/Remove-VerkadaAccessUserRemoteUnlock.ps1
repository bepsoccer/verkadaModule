function Remove-VerkadaAccessUserRemoteUnlock{
	<#
		...
		.EXAMPLE
		Remove-VerkadaAccessUserRemoteUnlock -externalId 'newUserUPN@contoso.com' -org_id '7cd47706-f51b-4419-8675-3b9f0ce7c12d' -x_verkada_auth_api 'sd78ds-uuid-of-verkada-token'
	...
	begin {
		$url = "https://$($region).verkada.com/access/v1/access_users/user/remote_unlock/deactivate"
