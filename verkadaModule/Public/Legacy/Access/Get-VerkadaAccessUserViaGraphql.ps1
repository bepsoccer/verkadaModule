function Get-VerkadaAccessUserViaGraphql{
	<#
		.SYNOPSIS
		...
		.LINK
		https://github.com/bepsoccer/verkadaModule/blob/master/docs/function-documentation/Get-VerkadaAccessUserViaGraphql.md
